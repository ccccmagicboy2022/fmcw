...
#define UART_BUF_LEN                     (20)//190==data£¬20==range
...
void OneRecursiveCanceller_motion(void);
void tagert_detect(void);
void location(void);
void quiksort(uint64_t a[],uint8_t low,uint8_t high);
void RegisterCallback(void (*debugfunc)(uint8_t* , uint16_t ));
#endif
